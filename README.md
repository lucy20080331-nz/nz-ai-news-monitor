...
The project follows a layered data warehouse architecture to separate data ingestion, transformation, business logic, and reporting.
...
| Layer | Purpose |
|-------|---------|
| **RAW** | Stores original news articles and LLM enrichment results. |
| **STG** | Cleans and standardises raw data. |
| **INT** | Applies business logic and prepares analytics-ready data. |
| **MART** | Creates reporting-ready datasets for Power BI. |
